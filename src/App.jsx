...
// Credit Deduction ONLY when download or print occurs with real-time Google Sheets sync
...
// 1. FIXED SESSION BUG: Initialize currentUser state to null if 'trisula_user_session' is missing/empty
...
// 2. FIXED PAYWALL TRIGGER FOR "+ BUAT PERANGKAT BARU": Global check if credit/quota <= 0
